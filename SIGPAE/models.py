...
class Historial(models.Model):
	...
	contenido = models.CharField(max_length = 512, default = "Sin seleccionar", null=True)
	objetivos_generales = models.CharField(max_length = 512, default = "", null=True, blank=True)
	objetivos_especificos = models.CharField(max_length = 512, default = "", null=True, blank=True)
