...
class Historial(models.Model):
    ...
    requisitos = models.CharField(max_length = 2048, default = "", null=True)
    estrategias_met = models.CharField(max_length = 2048, default = "", null=True, blank=True)
    estrategias_ev = models.CharField(max_length = 2048, default = "", null=True, blank=True)

    contenido = models.CharField(max_length = 2048, default = "Sin seleccionar", null=True)
    objetivos_generales = models.CharField(max_length = 2048, default = "", null=True, blank=True)
    objetivos_especificos = models.CharField(max_length = 2048, default = "", null=True, blank=True)
    fuentes_info = models.CharField(max_length = 2048, default = "", null=True, blank=True)
