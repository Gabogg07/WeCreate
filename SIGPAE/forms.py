...
class HistorialForm(forms.Form):
	...
	coordinacion_D1 = forms.ChoiceField(choices=COORDINACION_D1, label="Coordinación", required = False)
	coordinacion_D2 = forms.ChoiceField(choices=COORDINACION_D2, label="Coordinación", required = False)
	coordinacion_D3 = forms.ChoiceField(choices=COORDINACION_D3, label="Coordinación", required = False)
	division = forms.ChoiceField(choices=DIVISION, label="División", required = False)
	departamento_D1 = forms.ChoiceField(choices=DEPARTAMENTO_1, label="Departamento", required = False)
	departamento_D2 = forms.ChoiceField(choices=DEPARTAMENTO_2, label="Departamento", required = False)
	departamento_D3 = forms.ChoiceField(choices=DEPARTAMENTO_3, label="Departamento", required = False)
	departamento_D4 = forms.ChoiceField(choices=DEPARTAMENTO_4, label="Departamento", required = False)
	...
	estrategias_met = forms.CharField(label="Estrategias Metodológicas", required = False)
	estrategias_ev = forms.CharField(label="Estrategias de Evaluación", required = False)
	contenido = forms.ChoiceField(choices=CONTENIDO, label="Seleccione el tipo de contenido", required = False)
	objetivos_generales = forms.CharField(label="Objetivos Generales", required = False)
	objetivos_especificos = forms.CharField(label="Objetivos Específicos", required = False)
	fuentes_info = forms.CharField(label="Fuentes de Información recomendadas", required = False)
